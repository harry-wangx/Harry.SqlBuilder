...
#endif
{
    public sealed class UpdateBuilder : IUpdateBuilder
    {
        ...
        internal UpdateBuilder(ISqlBuilder factory, string table, string schema, int capacity)
        {
        ...
        public SqlBuilderCommand ToCommand(IDbTransaction transaction = null, int? commandTimeout = default(int?), CommandType? commandType = default(CommandType?))
        {
            ...
            foreach (var o in columns)
            {
                ...
                this.SqlBuilder.SqlGenerationHelper.DelimitIdentifier(sb, o.Name);
                sb.Append("=");
                this.SqlBuilder.SqlGenerationHelper.GenerateParameterName(sb, o.Name);
                i++;
            }
